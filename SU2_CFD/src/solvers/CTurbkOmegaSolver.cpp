/*!
 * \file CTurbkOmegaSolver.cpp
 * \brief Main subroutines of CTurbkOmegaSolver class
...
#include "../../include/solvers/CTurbkOmegaSolver.hpp"
#include "../../include/variables/CTurbkOmegaVariable.hpp"
#include "../../include/variables/CFlowVariable.hpp"
#include "../../../Common/include/parallelization/omp_structure.hpp"
#include "../../../Common/include/toolboxes/geometry_toolbox.hpp"


CTurbkOmegaSolver::CTurbkOmegaSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh)
  ...
  if (iMesh == MESH_0 || config->GetMGCycle() == FULLMG_CYCLE) {
    ...
    if (rank == MASTER_NODE) cout << "Initialize Jacobian structure (kOmega model)." << endl;
  ...
  nodes = new CTurbkOmegaVariable(kine_Inf, omega_Inf, muT_Inf, nPoint, nDim, nVar, constants, config);
...
void CTurbkOmegaSolver::Preprocessing(CGeometry *geometry, CSolver **solver_container, CConfig *config,
...
void CTurbkOmegaSolver::Postprocessing(CGeometry *geometry, CSolver **solver_container,
...
void CTurbkOmegaSolver::Viscous_Residual(unsigned long iEdge, CGeometry* geometry, CSolver** solver_container,
...
void CTurbkOmegaSolver::Source_Residual(CGeometry *geometry, CSolver **solver_container,
...
void CTurbkOmegaSolver::Source_Template(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics,
                                     CConfig *config, unsigned short iMesh) {
}

void CTurbkOmegaSolver::BC_HeatFlux_Wall(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
...
void CTurbkOmegaSolver::SetTurbVars_WF(CGeometry *geometry, CSolver **solver_container,
...
void CTurbkOmegaSolver::BC_Isothermal_Wall(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                                        CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CTurbkOmegaSolver::BC_Inlet(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                              CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CTurbkOmegaSolver::BC_Outlet(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                               CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CTurbkOmegaSolver::BC_Inlet_MixingPlane(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                                          CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CTurbkOmegaSolver::BC_Inlet_Turbo(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                                    CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CTurbkOmegaSolver::SetInletAtVertex(const su2double *val_inlet,
...
su2double CTurbkOmegaSolver::GetInletAtVertex(su2double *val_inlet,
...
void CTurbkOmegaSolver::SetUniformInlet(const CConfig* config, unsigned short iMarker) {
  if (config->GetMarker_All_KindBC(iMarker) == INLET_FLOW) {
    for (unsigned long iVertex = 0; iVertex < nVertex[iMarker]; iVertex++) {
