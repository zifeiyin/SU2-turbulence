/*!
 * \file CTurbkOmegaVariable.hpp
 * \brief Declaration of the variables of the KW turbulence model.
...
/*!
 * \class CTurbkOmegaVariable
 * \brief Main class for defining the variables of the turbulence model.
 * \ingroup Turbulence_Model
 * \author A. Bueno.
 */

class CTurbkOmegaVariable final : public CTurbVariable {
protected:
  su2double sigma_om2;
  su2double beta_star;
...
public:
   ...
   * \param[in] constants - kw model constants
   * \param[in] config - Definition of the particular problem.
   */
  CTurbkOmegaVariable(su2double kine, su2double omega, su2double mut, unsigned long npoint,
                   unsigned long ndim, unsigned long nvar, const su2double* constants, CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbkOmegaVariable() override = default;
