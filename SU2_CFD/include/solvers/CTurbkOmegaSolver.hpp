/*!
 * \file CTurbkOmegaSolver.hpp
 * \brief Headers of the CTurbkOmegaSolver class
...
/*!
 * \class CTurbkOmegaSolver
 * \brief Main class for defining the turbulence model solver.
 * \ingroup Turbulence_Model
 * \author A. Campos, F. Palacios, T. Economon
 */
class CTurbkOmegaSolver final : public CTurbSolver {
private:
...
public:
   ...
   */
  CTurbkOmegaSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbkOmegaSolver() = default;
  ...
  /*!
   * \brief Get the constants for the KW model.
